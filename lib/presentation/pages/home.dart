              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(
                      top: Dimens.dp16, left: Dimens.dp16, right: Dimens.dp16),
                  child: Text(
                    "Categories",
                    style:
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: boldTextStyle(
                                color: Colors.black, fontSize: Dimens.dp12),
                    ...
                    itemBuilder: (context, index) {
                      return Padding(
                        padding: EdgeInsets.only(
                            left: index == Dimens.dp0 ? Dimens.dp16 : Dimens.dp8,
                            right: index == controller.products.length - 1
                                ? Dimens.dp16
                                : Dimens.dp0),
                        child: InkWell(
                          onTap: (){
                            Get.toNamed(Routes.products, arguments: controller.products[index]["id"]);
                          },
                          child: Card(
                            elevation: 3,
                            color: Colors.white,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: regularTextStyle(
                                        fontSize: Dimens.dp10, color: Colors.grey),
                                    maxLines: 1,
                                    overflow: TextOverflow.ellipsis,
                                  ),
                                  const SizedBox(height: Dimens.dp4),
                                  ...
                                  Align(
                                    ...
                                    child: Obx(() {
                                      int quantity = cartController.getQuantity(controller.products[index]["id"]);
                                      return quantity > 0
                                          ? Container(
                                        height: 40,
                                        width: 130,
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            IconButton(
                                              onPressed: () {
                                                cartController.removeFromCart(controller.products[index]["id"]);
                                              },
                                            ...
                                            IconButton(
                                              onPressed: () {
                                                cartController.addToCart(controller.products[index]["id"]);
                                              },
                                        ...
                                        child: Text("Add to Cart",style: boldTextStyle(color: Colors.black,fontSize: Dimens.dp14),),
                                      );
                                    }),
                                  ),
                                ],
                ...
                Padding(
                  ...
                  child: Text(
                    "Seasonal Products",
                    style:
                    boldTextStyle(fontSize: Dimens.dp14, color: Colors.black),
                  ),
                ),
                const SizedBox(height: Dimens.dp8),
                ListView.builder(
